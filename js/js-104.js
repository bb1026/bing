...
// 日期天字体大小
// const wid = widgetcarton1.addStack();
// wid.setPadding(0, 10, 0, 0);
// wid.layoutVertically();
// const widgetsmd = wid.addStack();
// const widgetrq = wid.addStack();
// let wks = Array("日", "一", "二", "三", "四", "五", "六");
// let smdate = new Date();
// let ifd = ("0" + sd).slice(-2);
// for (i in wks) {
//   let td = new Date(
//     smdate.getTime() - 3600 * 1000 * 24 * (smdate.getDay() - i)
//   );
//   let sdd = ("0" + td.getDate()).slice(-2);
//   if (sdd == ifd) {
//     var cl = Color.red();
//     var ct = Font.boldMonospacedSystemFont(14);
//     var rqct = Font.boldMonospacedSystemFont(12);
//   } else {
//     var cl = Color.black();
//     var ct = Font.systemFont(14);
//     var rqct = Font.systemFont(12);
//   }
//   let xz = widgetsmd.addText(wks[i]);
//   widgetsmd.addSpacer(8);
//   let xzrq = widgetrq.addText(sdd);
//   widgetrq.addSpacer(8);
//   xz.font = ct;
//   xz.textColor = cl;
//   xzrq.font = ct;
//   xzrq.textColor = cl;
